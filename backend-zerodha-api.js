...
app.use(cors({
  origin: [
    ...
    'https://stock-watchlist-fixed-fgjlcw96b-noopurs-projects-93f3228e.vercel.app', // Keep old one for safety
...
app.get('/api/zerodha/auth/callback', async (req, res) => {
  ...
  try {
    ...
    res.redirect(`https://stock-watchlist-fixed-naqekif2a-noopurs-projects-93f3228e.vercel.app/?session=${sessionToken}`);
  } catch (error) {
