...
app.use(cors({
  origin: [
    'https://stock-watchlist-fixed-9hl6j4cvp-noopurs-projects-93f3228e.vercel.app',
...
app.get('/api/zerodha/auth/callback', async (req, res) => {
  ...
  try {
    ...
    res.redirect(`https://stock-watchlist-fixed-9hl6j4cvp-noopurs-projects-93f3228e.vercel.app/?session=${sessionToken}`);
  } catch (error) {
