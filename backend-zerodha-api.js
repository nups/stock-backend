...
app.use(cors({
  origin: [
    ...
    'https://stock-watchlist-fixed-3pdezlz7u-noopurs-projects-93f3228e.vercel.app', // Keep previous ones for safety
...
app.get('/api/zerodha/auth/callback', async (req, res) => {
  ...
  try {
    ...
    res.redirect(`https://stock-watchlist-fixed-5a00smuhi-noopurs-projects-93f3228e.vercel.app/?session=${sessionToken}`);
  } catch (error) {
